...
.breadcrumb-link {
    margin-right: 5px;
    /* Adjust the margin as needed for spacing between segments and links */
...
.breadcrumb-segment {
    margin-right: 5px;
    /* Adjust the margin as needed for spacing between segments */
}

.separator {
    margin: 0 5px;
    /* Adjust the margin as needed before and after the separator */
    color: black;
    /* Set the separator color (if needed) */
}
</style>